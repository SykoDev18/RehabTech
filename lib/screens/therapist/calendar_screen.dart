...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  Widget _buildAppointmentCard(Map<String, dynamic> appointment, String id) {
    ...
    final status = AppointmentStatus.fromString(appointment['status'] as String?);

    return InkWell(
      onTap: () => context.push('/therapist/appointments/$id'),
